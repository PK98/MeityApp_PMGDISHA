...
public class MODULE5 extends YouTubeBaseActivity implements YouTubePlayer.OnInitializedListener  {
    private static int Assessment5_Timeout=1*126;
    public static final String API_KEY="AIzaSyCK7RvonDKipBl43gGhESE0V1RrLXjIDvs";
    public static final String VIDEO_ID="7GoYNgAztUE";
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        ...
        new Handler().postDelayed(new Runnable() {
            @Override
            public void run() {
                Intent intent1=new Intent(MODULE5.this,Assessment5.class);
                startActivity(intent1);
            }
        },Assessment5_Timeout*1000);

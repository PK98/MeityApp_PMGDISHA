...
public class MODULE3 extends YouTubeBaseActivity implements YouTubePlayer.OnInitializedListener  {
    private static int Assessment3_Timeout=1*134;
    public static final String API_KEY="AIzaSyCK7RvonDKipBl43gGhESE0V1RrLXjIDvs";
    public static final String VIDEO_ID="99uaOzyySI4";
    @Override
    protected void onCreate(Bundle savedInstanceState) {
      ...
      new Handler().postDelayed(new Runnable() {
            @Override
            public void run() {
                Intent intent1=new Intent(MODULE3.this,Assessment3.class);
                startActivity(intent1);
            }
        },Assessment3_Timeout*1000);

...
public class MODULE4 extends YouTubeBaseActivity implements YouTubePlayer.OnInitializedListener  {
    private static int Assessment4_Timeout=1*90;
    public static final String API_KEY="AIzaSyCK7RvonDKipBl43gGhESE0V1RrLXjIDvs";
    public static final String VIDEO_ID="h1XlwM88Ho4";
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        ...
        new Handler().postDelayed(new Runnable() {
            @Override
            public void run() {
                Intent intent1=new Intent(MODULE4.this,Assessment4.class);
                startActivity(intent1);
            }
        },Assessment4_Timeout*1000);
